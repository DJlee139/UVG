...
public class TripStatisticsUpdater {
  ...
  //JERRID: UV Exposure Statistics
  /**
   * The number of light sensor readings to smooth to get a light intensity estimate.
   */
  @VisibleForTesting
  static final int LIGHT_SMOOTHING_FACTOR = 25;
  private final  DoubleBuffer lightBuffer = new DoubleBuffer(LIGHT_SMOOTHING_FACTOR);
  //-------------------
  ...
  public void addLocation(Location location, int minRecordingDistance) {
    ...
    if (!LocationUtils.isValidLocation(location)) {
      ...
      //JERRID: Note PAUSE_LATITUDE IS ACTUALLY DEFINED IN THE TrackRecordingService class
      //Global static vars is accessible from any class
