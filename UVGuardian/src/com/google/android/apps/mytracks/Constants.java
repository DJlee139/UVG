...
public class Constants {
  ...
  //JERRID: UVG PREFERENCE SPECIFIC VALUES
public static final String PROFILE_NAME="UVG_PROFILE_NAME";
public static final String PROFILE_SKIN_TYPE="UVG_PROFILE_SKIN_TYPE";
public static final String PROFILE_SKIN_TYPE_ICON="UVG_PROFILE_SKIN_TYPE_ICON";
public static final String PROFILE_SPF_FACTOR_ICON="UVG_PROFILE_SPF_FACTOR_ICON";
public static final String PROFILE_SPF_FACTOR="UVG_PROFILE_SPF_FACTOR"; 
  //***************
