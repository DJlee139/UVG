...
public class PreferencesUtils {
  ...
  /**
   * JERRID: Added because for some reason the getString() method returns false even
   * when the current context is active
   ...
   */
  public static String getStringConventional(Context context, String keyId, String defaultValue) {
    SharedPreferences sharedPreferences = context.getSharedPreferences(
        Constants.SETTINGS_NAME, Context.MODE_PRIVATE);
  ...
  /**
   * 
   * JERRID: Added because for some reason the setString() method returns false even
   * when the current context is active
   * Sets a string preference value.
   * 
   * @param context the context
   ...
   */
  @SuppressLint("CommitPrefEdits")
  public static void setStringConventional(Context context, String keyId, String value) {
